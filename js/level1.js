const cardsArray = [
    { img: 'img/castle_solid.png', id: 1 }, { img: 'img/castle_solid.png', id: 2 },
...
function createBoard() {
    ...
    cardsArray.forEach(card => {
        ...
        backFace.innerHTML = `<svg width="60" height="60" viewBox="0 0 102 93" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function resetGame() {
    ...
    timeLeft = 60; // Повертаємо значення таймера на початкове
    updateTimerDisplay(); // Оновлюємо дисплей таймера з новим значенням
    gameBoard.innerHTML = ''; // Очищення поля
    matchedPairs = 0;
    firstCard = null;
    secondCard = null;
    lockBoard = false;
